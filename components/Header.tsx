...
const Header: React.FC = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-[9999] px-2 md:px-12 pt-3 md:pt-6 pointer-events-none">
      <div
        ref={headerRef}
      ...
      >
        <div className={`absolute inset-0 transition-all duration-700 rounded-[25px] md:rounded-[55px] border border-white/30 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)] overflow-hidden ${scrolled ? 'bg-white/20 backdrop-blur-[55px]' : 'bg-white/10 backdrop-blur-[45px]'}`}>
        ...
        <div className="relative flex justify-between items-center h-14 md:h-20 px-4 md:px-12">
          <div className="flex items-center">
            <h1 className="text-lg md:text-3xl font-black tracking-tighter flex items-center gap-1.5 md:gap-4">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-fuchsia-400 to-orange-400 italic pr-2 md:pr-12 select-none animate-gradient-x whitespace-nowrap">
                Di Travel
              </span>
              <span className="w-1.5 md:w-3 h-1.5 md:h-3 rounded-full bg-orange-500 shadow-[0_0_20px_8px_rgba(249,115,22,0.8)] animate-pulse"></span>
            </h1>
          </div>
          ...
          <div className="flex items-center gap-4 md:gap-8">
            ...
            <a
              ...
              className="relative overflow-hidden px-4 md:px-14 py-2 md:py-4 rounded-lg md:rounded-2xl font-black uppercase text-[8px] md:text-[11px] tracking-[0.1em] md:tracking-[0.2em] transition-all duration-300 flex items-center justify-center bg-orange-500 text-white shadow-xl group/btn cursor-pointer touch-none whitespace-nowrap"
            >
